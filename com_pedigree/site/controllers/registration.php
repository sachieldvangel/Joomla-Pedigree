 ...
 */
class PedigreeControllerRegistration extends PedigreeController {
    ...
    public function edit() {
        ...
        $this->setRedirect(JRoute::_('index.php?option=com_pedigree&view=registrationform&layout=edit', false));
    }
