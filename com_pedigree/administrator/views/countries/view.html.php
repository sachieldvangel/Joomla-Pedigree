 ...
 */
class PedigreeViewCountries extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        PedigreeHelper::addSubmenu('countries');
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_PEDIGREE_TITLE_COUNTRIES'), 'countries.png');
        ...
        JHtmlSidebar::setAction('index.php?option=com_pedigree&view=countries');
	...
	protected function getSortFields()
	{
		...
		'a.short_name' => JText::_('COM_PEDIGREE_COUNTRIES_SHORT_NAME'),
		'a.long_name' => JText::_('COM_PEDIGREE_COUNTRIES_LONG_NAME'),
		'a.iso2' => JText::_('COM_PEDIGREE_COUNTRIES_ISO2'),
		'a.iso3' => JText::_('COM_PEDIGREE_COUNTRIES_ISO3'),
		'a.numcode' => JText::_('COM_PEDIGREE_COUNTRIES_NUMCODE'),
		'a.un_member' => JText::_('COM_PEDIGREE_COUNTRIES_UN_MEMBER'),
		'a.calling_code' => JText::_('COM_PEDIGREE_COUNTRIES_CALLING_CODE'),
		'a.cctld' => JText::_('COM_PEDIGREE_COUNTRIES_CCTLD'),
		'a.ordering' => JText::_('JGRID_HEADING_ORDERING'),
		'a.state' => JText::_('JSTATUS'),
		'a.checked_out' => JText::_('COM_PEDIGREE_COUNTRIES_CHECKED_OUT'),
		'a.checked_out_time' => JText::_('COM_PEDIGREE_COUNTRIES_CHECKED_OUT_TIME'),
		'a.created_by' => JText::_('COM_PEDIGREE_COUNTRIES_CREATED_BY'),
		);
	}
