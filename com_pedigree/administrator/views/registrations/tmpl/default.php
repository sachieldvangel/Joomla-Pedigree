...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_pedigree&task=registrations.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'registrationList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
