...
if($this->item->id) {
	$canState = JFactory::getUser()->authorise('core.edit.state','com_pedigree.owner');
} else {
	$canState = JFactory::getUser()->authorise('core.edit.state','com_pedigree.owner.'.$this->item->id);
}
?>
</style>
<script type="text/javascript">
    getScript('//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js', function() {
        jQuery(document).ready(function() {
            jQuery('#form-owner').submit(function(event) {
...
<div class="owner-edit front-end-edit">
    ...
    <form id="form-owner" action="<?php echo JRoute::_('index.php?option=com_pedigree&task=owner.save'); ?>" method="post" class="form-validate form-horizontal" enctype="multipart/form-data">
