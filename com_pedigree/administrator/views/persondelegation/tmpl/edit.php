...
<script type="text/javascript">
    ...
    {
        if (task == 'persondelegation.cancel') {
            Joomla.submitform(task, document.getElementById('persondelegation-form'));
        }
        else {
            
            if (task != 'persondelegation.cancel' && document.formvalidator.isValid(document.id('persondelegation-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_pedigree&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="persondelegation-form" class="form-validate">

    <div class="form-horizontal">
        <?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

        <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_PEDIGREE_TITLE_PERSONDELEGATION', true)); ?>
        <div class="row-fluid">
