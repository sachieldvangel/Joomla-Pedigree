 ...
 * View to edit
 */
class PedigreeViewOwner extends JViewLegacy {
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_PEDIGREE_TITLE_OWNER'), 'owner.png');
        ...
        if (empty($this->item->id)) {
            JToolBarHelper::cancel('owner.cancel', 'JTOOLBAR_CANCEL');
        } else {
