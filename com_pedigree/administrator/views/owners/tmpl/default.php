...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_pedigree&task=owners.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'ownerList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<?php endif;?>
		...
		<table class="table table-striped" id="ownerList">
			...
			<?php foreach ($this->items as $i => $item) :
                ...
                <?php if (isset($this->items[0]->state)): ?>
					<td class="center">
						<?php echo JHtml::_('jgrid.published', $item->state, $i, 'owners.', $canChange, 'cb'); ?>
					</td>
                <?php endif; ?>
