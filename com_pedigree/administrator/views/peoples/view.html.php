 ...
 */
class PedigreeViewPeoples extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		PedigreeHelper::addSubmenu('peoples');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_PEDIGREE_TITLE_PEOPLES'), 'peoples.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_pedigree&view=peoples');
	...
	protected function getSortFields()
	{
		...
		'a.first_name' => JText::_('COM_PEDIGREE_PEOPLES_FIRST_NAME'),
		'a.last_name' => JText::_('COM_PEDIGREE_PEOPLES_LAST_NAME'),
		'a.id_country' => JText::_('COM_PEDIGREE_PEOPLES_ID_COUNTRY'),
		'a.email' => JText::_('COM_PEDIGREE_PEOPLES_EMAIL'),
		'a.website' => JText::_('COM_PEDIGREE_PEOPLES_WEBSITE'),
		'a.fb_profile' => JText::_('COM_PEDIGREE_PEOPLES_FB_PROFILE'),
		'a.kennel_name' => JText::_('COM_PEDIGREE_PEOPLES_KENNEL_NAME'),
		'a.is_judge' => JText::_('COM_PEDIGREE_PEOPLES_IS_JUDGE'),
		'a.state' => JText::_('JSTATUS'),
		'a.checked_out' => JText::_('COM_PEDIGREE_PEOPLES_CHECKED_OUT'),
		'a.created_by' => JText::_('COM_PEDIGREE_PEOPLES_CREATED_BY'),
		);
	}
